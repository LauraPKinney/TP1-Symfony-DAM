...
class EmployesController extends AbstractController
{
    ...
    #[Route('/employes/new', name: 'app_employes_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EmployesRepository $employesRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $employesRepository->add($employe, true);
    ...
    #[Route('/employes/{id}', name: 'app_employes_show', methods: ['GET'])]
    ...
    #[Route('/employes/{id}/edit', name: 'app_employes_edit', methods: ['GET', 'POST'])]
